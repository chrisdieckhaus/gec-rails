class NewsController < ApplicationController
  def news
    @articles = [{title: "Why We Need More Disruptive Women",
                 ...
                 blurb: "'After participating in a summer engineering program at Vanderbilt, Christine Schindler of Duke University
                    developed a deep passion for engineering. During the program, Christine realized that most people hold many
