class NewsController < ApplicationController
  def news
    @articles = [{title: "Girls Engineering Change wants to close gender gap in engineering",
                  site: "News & Observer",
                  src: "http://www.newsobserver.com/2014/10/22/4254650/girls-engineering-change-wants.html",
            ...
            {title: "Why We Need More Disruptive Women",
